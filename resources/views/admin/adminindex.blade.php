                                ...
                                <table class="table table-report sm:mt-2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center whitespace-nowrap">DESKRIPSI 1</th>
                                            <th class="text-center whitespace-nowrap">DESKRIPSI 2</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td class="">{{ $item->deskripsi_1 }}</td>
                                        <td class="">{{ $item->deskripsi_2 }}</td>
