        ...
        <div class="content">
            ...
            <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                ...
                <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Ubah Foto Wisata</li>
                    </ol>
                </nav>
                <!-- END: Breadcrumb -->
            </div>
            ...
            <div class="">
                <div class="intro-y col-span-11 2xl:col-span-9">
                    <form action="{{ route('ubah-foto-wisata', ['id' => $foto_wisata->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
