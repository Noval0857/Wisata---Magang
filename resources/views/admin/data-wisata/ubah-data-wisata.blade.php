    ...
    <div class="mobile-menu md:hidden">
        ...
        <div class="scrollable">
            ...
            <ul class="scrollable__content py-2">
                ...
                <li>
                    <a href="{{ url('data-user') }}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="message-square"></i> </div>
                        <div class="side-menu__title"> Data User </div>
                    </a>
                </li>
                <li>
                    <a href="{{ url('foto-wisata') }}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="message-square"></i> </div>
                        <div class="side-menu__title"> Foto Wisata </div>
                    </a>
                </li>
                <li>
                    <a href="{{ url('komentar') }}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="message-square"></i> </div>
    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <nav class="side-nav">
            ...
            <ul>
                ...
                <li>
                    <a href="{{ url('kategori-wisata') }}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="message-square"></i> </div>
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                <div class="mt-5">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="deskripsi_1" name="deskripsi_1" type="text" class="form-control" placeholder="Deskripsi Wisata">{{ $wisatas->deskripsi_1 }}</textarea>
                                        </div>
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="deskripsi_2" name="deskripsi_2" type="text" class="form-control" placeholder="Deskripsi Wisata">{{ $wisatas->deskripsi_2 }}</textarea>
                                        </div>
                                    </div>
                                    <div
                                        class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
