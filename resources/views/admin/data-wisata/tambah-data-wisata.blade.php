                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                <div class="mt-5">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="deskripsi_1" name="deskripsi_1" type="text" class="form-control" placeholder="Deskripsi Wisata"></textarea>
                                        </div>
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="deskripsi_2" name="deskripsi_2" type="text" class="form-control" placeholder="Deskripsi Wisata"></textarea>
                                        </div>
                                    </div>
                                    <div
                                        class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
