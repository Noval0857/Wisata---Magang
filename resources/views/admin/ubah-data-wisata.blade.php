                ...
                <div class="intro-y col-span-11 2xl:col-span-9">
                    <form action="{{ url('simpan-data-wisata/' . $wisatas->id) }}" method="POST"
                                        ...
                                        <div class="form-label w-full xl:w-64 xl:!mr-10">
                                            <div class="text-left">
                                                ...
                                                <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                                    <div>The image format is .jpg .jpeg .png and a minimum size of 300 x
                                                        300 pixels (For optimal images use a minimum size of 700 x 700
                                                        pixels).</div>
                                                    <div class="mt-2">Select product photos or drag and drop up to 5
                                                        photos at once here. Include min. 3 attractive photos to make
                                                        the product more attractive to buyers.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <div class="px-4 pb-4 mt-5 flex items-center justify-center cursor-pointer relative">
                                                ...
                                                <input id="foto" type="file" name="foto" class="w-full h-full top-0 left-0 absolute opacity-0" accept=".jpeg, .jpg, .png" onchange="previewImage(event)">
                                            </div>
                                            
                                            <!-- Display the current image if exists -->
                                            @if($wisatas->path)
                                                <div class="mt-4">
                                                    <img id="currentImage" src="{{ Storage::url($wisatas->path) }}" alt="Current Image" style="max-width: 200px;">
                                                </div>
                                            @endif
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <input id="nama_wisata" name="nama_wisata" type="text"
                                                class="form-control" placeholder="Nama wisata" value="{{ $wisatas->nama_wisata }}">
                                        </div>
                                    </div>
                                    <div
                                        class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        <div class="form-label xl:w-64 xl:!mr-10">
                                            <div class="text-left">
                                                ...
                                                <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                                    <div>Make sure the product description provides a detailed
                                                        explanation of your product so that it is easy to understand and
                                                        find your product.</div>
                                                    <div class="mt-2">It is recommended not to enter info on mobile
                                                        numbers, e-mails, etc. into the product description to protect
                                                        your personal data.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="deskripsi" name="deskripsi" type="text" class="form-control" placeholder="Deskripsi Wisata"
                                                >{{ $wisatas->deskripsi }}</textarea>
                                        </div>
                                    </div>
                                    <div
                                        class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="alamat" name="alamat" type="text" class="form-control"
                                                placeholder="Alamat wisata" >{{ $wisatas->alamat }}</textarea>
                                        </div>
                                    </div>
                                    <div
                                        class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="flex justify-end flex-col md:flex-row gap-2 mt-5">
                            ...
                            <button type="submit"
                                class="btn py-3 border-slate-300 dark:border-darkmode-400 text-slate-500 w-full md:w-52">Save
