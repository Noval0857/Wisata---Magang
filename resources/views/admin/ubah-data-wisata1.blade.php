...
<body>
    ...
    <main>
        ...
        <form class="relative px-16 py-16 sm:px-8 lg:px-72 lg:py-16" action="{{ url('simpan-data-wisata/'. $wisatas->id) }}" method="POST">
            {{ csrf_field() }}
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="foto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Foto</label>
                <input type="file" name="foto" id="foto"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    value="{{ $wisatas->gambar }}" required/>
            </div>
            <div class="mb-5">
                <label for="google_maps_url" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Google Maps URL</label>
                <input type="text" name="google_maps_url" id="google_maps_url"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    placeholder="" value="{{ $wisatas->google_maps_url }}" required  />
            </div>
            <button type="submit"
