        ...
        <div class="content">
            ...
            <div class="">
                <div class="intro-y col-span-11 2xl:col-span-9">
                    <form action="{{ url('simpan-data') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="deskripsi" name="deskripsi" type="text" class="form-control" placeholder="Deskripsi Wisata"></textarea>
                                        </div>
                                    </div>
                                    <div
                                        class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea id="alamat" name="alamat" type="text" class="form-control"
                                                placeholder="Alamat wisata"></textarea>
                                        </div>
                                    </div>
                                    <div
                                        class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
