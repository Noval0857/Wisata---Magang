...
<body class="home-page-1">
    ...
    <aside id="sidebar-wrapper" class="custom-scrollbar offcanvas-sidebar">
        <button class="off-canvas-close"><img class="svg-icon-24" src="assets/imgs/theme/svg/close.svg"
                alt=""></button>
        ...
        <div class="position-relative">
            <div class="container align-self-center">
                <div class="header-style-1">
                    <div class="logo">
                        <a href="index.html"><img src="" alt="">WisBJM</a>
                    </div>
                    <div class="main-nav d-none d-lg-block">
                        <nav>
                            ...
                            <ul class="main-menu d-none d-lg-inline">
                                ...
                                <li class="menu-item-has-children">
                                    <a href="category.html">Wisata</a>
                                    <ul class="sub-menu font-small">
                                        <li><a href="category-big.html">Alam</a></li>
                                        <li><a href="category-grid.html">Budaya</a></li>
                                        <li><a href="category-list.html">Kuliner</a></li>
                                        <li><a href="category-list-2.html">Sejarah</a></li>
                                    </ul>
                                </li>
                            ...
                            <ul id="mobile-menu" class="d-block d-lg-none text-muted">
                                ...
                                <li class="menu-item-has-children"><a href="#">Single post</a>
                                    <ul class="sub-menu font-small">
                                        ...
                                        <button
                                            class="btn btn-md bg-dark text-white ml-15 box-shadow d-none d-lg-inline d-md-inline d-sm-inline"><a
                                                href="page-contact.html">Login</a></button>
                                    </ul>
                                </li>
                            ...
                            <div class="input-group w-100">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-search bg-white" type="submit">
                                        <img class="svg-icon-24" src="assets/imgs/theme/svg/search.svg"
                                            alt="">
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 align-self-center">
                                    ...
                                    <div class="post-meta-2 font-md d-flext align-self-center mb-md-30">
                                        <a href="page-author.html">
                                            <img src="assets/imgs/authors/" alt="">
