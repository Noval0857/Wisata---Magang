                ...
                <ul
                    ...
                    @if (auth()->check() && auth()->user()->role == 'admin')
                        <li
                            ...
                            <a href='{{ url('admin') }}' class='text-white block text-[15px]'>Admin</a>
                        </li>
                    @endif
                    <li
                        class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300'>
                        <a href='{{ url('/') }}' class='text-white block text-[15px]'>Home</a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative group lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300'
                        id="dropdown">
                        <a href='javascript:void(0)' class='text-white block text-[15px]'>Wisata</a>
                        <ul class="group-hover:block absolute bg-slate-500 lg:mt-6 lg:shadow-lg lg:rounded-lg transition-opacity duration-300 opacity-0 group-hover:opacity-100"
                            ...
                            <li class="py-2 px-4 lg:hover:bg-slate-600">
                                <a href="#" class="text-white block text-[15px]">Alam</a>
                            </li>
                            <li class="py-2 px-4 lg:hover:bg-slate-600">
                                <a href="#" class="text-white block text-[15px]">Budaya</a>
                            </li>
                            <li class="py-2 px-4 lg:hover:bg-slate-600">
                                <a href="#" class="text-white block text-[15px]">Kuliner</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li
                        class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300'>
                        <a href='javascript:void(0)' class='text-white block text-[15px]'>Support</a>
                    </li>
                    <li
                        class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300'>
                        <a href='javascript:void(0)' class='text-white block text-[15px]'>Account</a>
                    </li>
                    <li
                        class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300'>
                        <a href='javascript:void(0)' class='text-white block text-[15px]'>Places</a>
                    </li>
                    <li
                        class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300'>
                        <a href='javascript:void(0)' class='text-white block text-[15px]'>Contact</a>
                    </li>
                </ul>
            </div>
            ...
            <div class='flex items-center max-sm:ml-auto space-x-6'>
                <ul>
                    <li
                        ...
                        <div id="userMenu"
                            class="bg-white z-20 shadow-md py-6 px-6 sm:min-w-[320px] max-sm:min-w-[250px] absolute right-0 top-10 hidden">
                            @if (auth()->check())
                                <a href="{{ route('logout') }}"
                                    class="bg-transparent border-2 border-gray-300 hover:border-black rounded px-4 py-2.5 mt-10 text-sm text-black font-semibold">
                                    LOGOUT
                                </a>
                ...
                <button id="toggleOpen" class='lg:hidden ml-7'>
                    <svg class="w-7 h-7" fill="#ffff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <button id="toggleClose" class='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white p-3 hidden'>
