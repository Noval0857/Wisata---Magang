            ...
            <nav
                ...
                <ul class="md:flex items-center">
                    ...
                    <li><a class="py-2 inline-block md:text-white md:hidden lg:block font-semibold hover:text-sky-500"
                            href="{{ url('/') }}">Home</a></li>
                    <li class="md:ml-4"><a
                            class="py-2 inline-block md:text-white md:px-2 font-semibold hover:text-sky-500"
                            href="{{ url('about') }}">About</a></li>
                    <li class='group md:ml-4 relative'>
                        <a href='javascript:void(0)'
                            class='hover:text-sky-500 md:text-white text-[15px] font-bold lg:hover:fill-[#007bff] block'>Wisata
                        </a>
                        <ul
                            class='absolute shadow-lg bg-white space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[250px] max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
                    ...
                    @if (auth()->check())
                        ...
                        <li class="relative md:ml-6 mt-3 md:mt-0">
                            <img src="{{ asset('images/profil-blank.webp') }}" alt="Profile Picture"
                                class="w-10 h-10 rounded-full border border-gray-300 shadow-sm cursor-pointer"
                                id="profile-icon"
                                onerror="this.onerror=null;this.src='/path/to/default-user-icon.jpg';">
                            <!-- Dropdown Menu -->
                            <div id="profile-dropdown"
                                class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg hidden">
                                <div class="py-2">
                                    <a href="/user/profile" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">My
                                        Profile</a>
                                </div>
                                <div class="py-2 border-t border-gray-200">
                                    <a type="submit" class="w-full text-left" href="{{ route('logout') }}">Log Out</a>
                                </div>
                            </div>
                        </li>
                    @else
...
{{-- <header class='flex border-b font-sans min-h-[70px] tracking-wide relative z-50' style="background-color: ">
