                ...
                <button type="button"
                    ...
                    @if (auth()->check())
                        @php
                            ...
                            $profileImage = $userProfile && $userProfile->foto_profil
                    ...
                    <li>
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                ...
                                <li>
                                    <a href="{{ route('wisata-category', 'alam') }}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Alam</a>
                                </li>
                                <li>
                                    <a href="{{ route('wisata-category', 'budaya') }}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Budaya</a>
                                </li>
                                <li>
                                    <a href="{{ route('wisata-category', 'kuliner') }}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kuliner</a>
                                </li>
                            </ul>
                        </div>
                    </li>
